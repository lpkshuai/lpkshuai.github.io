---
slug: crlf-lf-concept
title: CRLF和LF区别
category: Engineering
type: concept
description: CRLF 和 LF 概念和区别。
status: published
tags: Git, CRLF, LF, 工程化
...
- 使用 Windows 系统的开发`git config --global core.aurocrlf true`
- 使用Linux/MacOS 的开发`git config --global core.autocrlf input`
