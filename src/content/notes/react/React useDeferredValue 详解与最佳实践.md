---
slug: react-usedeferredvalue-concept
title: React useDeferredValue 详解与最佳实践
category: React
type: concept
description: 深入理解 React 18 useDeferredValue 的作用、使用场景、适用边界以及与 debounce、useTransition 的区别。
status: published
tags: React, React18, Hooks, Performance, Concurrent Rendering
...
```tsx
const filteredNotes = notes.filter((note) => note.title.includes(searchQuery));
```
