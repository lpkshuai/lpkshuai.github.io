---
slug: vue3-scroll-to-top
title: vue3 中路由切换后让页面返回到顶部
category: Vue
type: snippet
description: 记录在 vue3 中，不同情况下，路由切换时让页面正常返回到顶部的方法。
status: published
...
> ![image](/notes/vue/vue3-scroll-to-top.png)
...
- 方法一
  ...
  > [详见地址](https://router.vuejs.org/zh/guide/advanced/scroll-behavior.html "详见地址")
