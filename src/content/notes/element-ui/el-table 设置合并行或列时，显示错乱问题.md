...
title: el-table 设置合并行或列时，显示错乱问题
category: Vue
type: snippet
description: 记录 el-table 合并行或列时显示错乱问题的解决方法。
status: published
