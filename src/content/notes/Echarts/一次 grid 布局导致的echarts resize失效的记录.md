---
slug: echarts-grid-resize
title: 一次 grid 布局导致的echarts resize失效的记录
category: Echarts
type: review
description: 一次 grid 布局导致的echarts resize失效的记录。
status: published
tags: Echarts, grid
...
![image](/notes/echarts/echarts-resize-grid-error.png)
...
![image](/notes/echarts/echarts-resize-grid-fix.png)
