    ...
    <header className="sticky top-0 z-50 border-b border-white/6 bg-white/2 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        >
          ...
          {/* 【核心徽章】左侧等级框 */}
          <div className="relative flex h-8 w-8 items-center justify-center rounded border border-(--accent-strong) bg-(--panel) shadow-[0_0_10px_rgba(56,189,248,0.15)] transition-all duration-300 group-hover:border-(--accent) group-hover:shadow-[0_0_15px_var(--accent)] overflow-hidden">
            {/* 平时状态：静态显示 "LV" */}
